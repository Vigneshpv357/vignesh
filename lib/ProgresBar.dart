...
class ProgresDial extends StatefulWidget {
  const ProgresDial({Key? key}) : super(key: key);

  @override
  State<ProgresDial> createState() => _ProgresDialState();
}

class _ProgresDialState extends State<ProgresDial> {
